            ...
            <nav className="w-1/2 mx-auto relative">
                <div className="max-w-screen-xl flex items-center justify-center mx-auto p-4">
                    <ul className="font-medium py-2 px-5 flex flex-col border border-gray-100 rounded-lg bg-gray-50 shadow-md md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                        ...
                        <li className="flex-grow">
                            <a className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-green-500 md:p-0 text-nowrap cursor-pointer"
                                onClick={() => {
                        ...
                        <li className="flex-grow">
                            <a className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-red-500 md:p-0 text-nowrap cursor-pointer"
                                onClick={() => {
                                    navigate('/signin');
                                    removeCookie("token");
                                    // window.location.reload();
